...
- signature: `analysis/configs/c32_homoharringtonine_5um_signature.json`

The signature contains the 25 strongest mapped up genes and 25 strongest mapped down genes from the real plate-6 pseudobulk profile. Plate-14 aggregate concordance was already visible when this condition was chosen. Plate 14 is therefore a retrospective replication check, not a blinded validation set.
